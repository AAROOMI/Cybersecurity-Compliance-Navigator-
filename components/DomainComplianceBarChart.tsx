...
interface DomainComplianceBarChartProps {
    data: AssessmentItem[];
}
...
export const DomainComplianceBarChart: React.FC<DomainComplianceBarChartProps> = ({ data }) => {
        ...
        chartRef.current = new Chart(canvasRef.current, {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Compliance Status by Domain',
                        color: textColor,
                        font: {
                            size: 18
                        }
