...
interface PDPLDomainComplianceBarChartProps {
    data: AssessmentItem[];
}
...
export const PDPLDomainComplianceBarChart: React.FC<PDPLDomainComplianceBarChartProps> = ({ data }) => {
        ...
        chartRef.current = new Chart(canvasRef.current, {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'PDPL Compliance Status by Domain',
                        color: textColor,
                        font: {
                            size: 18
                        }
