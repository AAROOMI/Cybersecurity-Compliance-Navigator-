...
export const samaCsfAssessmentData: AssessmentItem[] = [
    {
        ...
        saudiCeramicsCurrentStatus: "A high-level IT security strategy exists, but it has not been formally approved by the board and lacks specific alignment with SAMA CSF.",
    ...
    },
    {
        ...
        saudiCeramicsCurrentStatus: "Cyber security matters are discussed within the IT steering committee, but a dedicated, board-level cyber security committee does not exist.",
        controlStatus: "Partially Implemented",
    ...
    },
    {
        ...
        saudiCeramicsCurrentStatus: "IT security policies exist but have not been updated in the last two years and do not fully align with SAMA CSF.",
        controlStatus: "Partially Implemented",
    ...
    },
    {
        ...
        saudiCeramicsCurrentStatus: "An IT asset inventory is maintained, but it does not formally link assets to critical business processes or assign criticality ratings.",
        controlStatus: "Partially Implemented",
    ...
    },
    {
        ...
        saudiCeramicsCurrentStatus: "Annual risk assessments are performed, but they are not consistently scoped to cover all critical assets as defined by SAMA CSF.",
        controlStatus: "Partially Implemented",
    ...
    },
    {
        ...
        saudiCeramicsCurrentStatus: "High-level risks are documented, but formal risk treatment plans with assigned owners and timelines are not consistently created or tracked.",
        controlStatus: "Partially Implemented",
    ...
    },
    {
        ...
        saudiCeramicsCurrentStatus: "Vulnerability scanning is in place. Annual penetration testing has been conducted, but there is no formal threat intelligence program.",
        controlStatus: "Partially Implemented",
    ...
    },
    {
        ...
        saudiCeramicsCurrentStatus: "An incident response plan exists, but it has not been tested via tabletop or simulation exercises in the last 12 months.",
    ...
    },
    {
        ...
        saudiCeramicsCurrentStatus: "Privileged accounts use shared passwords stored in a spreadsheet. There is no PAM solution in place.",
        controlStatus: "Not Implemented",
    ...
    },
    {
        ...
        saudiCeramicsCurrentStatus: "No DLP solution is in place, creating a risk of unauthorized exfiltration of sensitive financial data.",
        controlStatus: "Not Implemented",
    ...
    },
    {
        ...
        saudiCeramicsCurrentStatus: "Logs are collected locally but not centralized or correlated. Monitoring is performed on an ad-hoc basis during business hours only.",
        controlStatus: "Not Implemented",
    ...
    },
    {
        ...
        saudiCeramicsCurrentStatus: "Third-party contracts include basic security clauses, but a formal risk assessment process for onboarding and monitoring third parties is not in place.",
        controlStatus: "Not Implemented",
    ...
    },
    {
        ...
        saudiCeramicsCurrentStatus: "Once a third party is onboarded, no further security reviews are performed during the contract lifecycle.",
        controlStatus: "Not Implemented",
