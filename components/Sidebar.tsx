...
import { DocumentIcon, UsersIcon, BuildingOfficeIcon, DashboardIcon, ClipboardListIcon, BeakerIcon, ClipboardCheckIcon } from './Icons';
...
interface SidebarProps {
  ...
  currentView: 'dashboard' | 'navigator' | 'documents' | 'users' | 'companyProfile' | 'auditLog' | 'assessment';
  onSetView: (view: 'dashboard' | 'navigator' | 'documents' | 'users' | 'companyProfile' | 'auditLog' | 'assessment') => void;
  ...
  return (
    <aside className="w-64 bg-white dark:bg-gray-800 p-4 border-r border-gray-200 dark:border-gray-700 overflow-y-auto hidden md:flex md:flex-col">
      <div className="flex items-center mb-6">
        ...
        <h1 className="ml-3 text-xl font-bold text-gray-800 dark:text-gray-100">AI Studio Apps</h1>
      </div>
      <nav className="mb-6">
        <ul>
